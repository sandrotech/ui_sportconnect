        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/arenas" className="text-white/60 hover:text-white transition-colors">Arenas</Link></li>
              <li><Link href="/atletas" className="text-white/60 hover:text-white transition-colors">Atletas</Link></li>
              <li><Link href="/profissionais" className="text-white/60 hover:text-white transition-colors">Profissionais</Link></li>
              <li><Link href="/marketplace" className="text-white/60 hover:text-white transition-colors">Marketplace</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/parceiros" className="text-white/60 hover:text-white transition-colors">Parceiros</Link></li>
